          ...
          <li>
            <Link href="/dashboard" passHref legacyBehavior>
              <a className="block w-full">
                <CustomButton 
                  variant="text" 
                  className="w-full flex items-center justify-start p-3 hover:bg-zinc-800 rounded-lg text-white font-normal"
                >
        ...
        <div className="space-y-2">
          <Link href="/terms" passHref legacyBehavior>
            <a className="block w-full">
              <CustomButton 
                variant="text" 
                className="w-full text-center text-sm text-[#E0407B] hover:text-pink-600 font-normal"
              >
                Terms & Conditions
              </CustomButton>
            </a>
