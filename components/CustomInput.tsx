  ...
  return (
    <div className="relative">
      <div className="relative group">
        <div 
            className={`absolute -inset-[1px] bg-gray-700 rounded-full transition duration-300 opacity-0 group-focus-within:opacity-100 group-focus-within:bg-gradient-to-r from-purple-600 via-pink-500 to-blue-500 ${!!error ? '!opacity-100' : ''}`}
