...
const MembersPage: React.FC = () => {
  ...
  const getSourceColor = (source: string) => {
    const colors = {
      eventbrite: 'bg-[#E0407B]/10 text-[#E0407B] border border-[#E0407B]/20',
      manual: 'bg-gray-700 text-gray-300 border border-gray-600',
      csv: 'bg-gray-700 text-gray-300 border border-gray-600',
    };
  ...
  const getStatusColor = (status: string) => {
    return status === 'active' 
      ? 'bg-[#E0407B]/10 text-[#E0407B] border border-[#E0407B]/20' 
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#E0407B] focus:border-transparent"
            />
          </div>
        </div>
        ...
        <select
          ...
          className="px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-[#E0407B] focus:border-transparent"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="p-4 bg-gray-800/50 rounded-xl border border-gray-700 hover:border-[#E0407B]/30 transition-all duration-300">
          <div className="flex items-center">
            <div className="w-10 h-10 bg-[#E0407B]/10 rounded-lg flex items-center justify-center mr-3 border border-[#E0407B]/20">
        ...
        <div className="p-4 bg-gray-800/50 rounded-xl border border-gray-700 hover:border-gray-600 transition-all duration-300">
          <div className="flex items-center">
            <div className="w-10 h-10 bg-gray-700 rounded-lg flex items-center justify-center mr-3 border border-gray-600">
        ...
        <div className="p-4 bg-gray-800/50 rounded-xl border border-gray-700 hover:border-gray-600 transition-all duration-300">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">From Eventbrite</p>
            </div>
          </div>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          <div className="w-24 h-24 bg-gray-800/50 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredMembers.map((member) => (
            ...
            >
              <div className="relative rounded-2xl overflow-hidden bg-gray-800/50 border border-gray-700 hover:border-[#E0407B]/30 transition-all duration-300">
                <div className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-shrink-0">
                      {member.imageUrl ? (
                        ...
                        <div className="w-16 h-16 rounded-xl bg-[#E0407B]/10 flex items-center justify-center border border-[#E0407B]/20">
                          <span className="text-[#E0407B] font-bold text-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-bold text-white mb-1 group-hover:text-[#E0407B] transition-colors truncate">
                        {member.name}
                      </h3>
                      ...
                      {(member.linkedinUrl || member.twitterUrl) && (
                        <div className="flex space-x-2 mt-3">
                          {member.linkedinUrl && (
                            <div className="w-6 h-6 bg-gray-700 rounded flex items-center justify-center border border-gray-600">
