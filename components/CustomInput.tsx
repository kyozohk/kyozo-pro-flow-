      ...
      <div className="relative group">
        ...
        <div className="relative">
            <input
              ...
              placeholder=" " 
              disabled={disabled}
              className={`peer w-full px-4 py-3 bg-[#2C2C2E] rounded-xl text-white border transition-colors ${error ? 'border-red-500' : 'border-gray-600'} focus:border-transparent focus:outline-none ${disabled ? 'opacity-60 cursor-not-allowed' : ''}`}
              required
            />
            <label
              htmlFor={name}
